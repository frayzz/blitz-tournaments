                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                ...
                                <span class="text-secondary">
                                    <label>
                                        <input type="text" class="form-control" name="telegram" value="{{  $user->profile->telegram }}">
                                    </label>
                                </span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                ...
                                <span class="text-secondary">
                                    <label>
                                        <input type="text" class="form-control" name="steam" value="{{  $user->profile->steam }}">
                                    </label>
                                </span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                ...
                                <span class="text-secondary">
                                    <label>
                                        <input type="text" class="form-control" name="instagram" value="{{  $user->profile->instagram }}">
                                    </label>
                                </span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                <button type="submit" class="btn btn-primary btn-lg">Сохранить</button>
                                <a href="{{ route('profile', $user->id) }}" class="btn btn-outline-dark btn-lg">Отменить</a>
                            </li>
                        </ul>
                    </div>
                </form>
                        ...
                        @foreach($matches['matches'] as $match)
                            ...
                            <div class="row align-items-center">
                                <div class="col-sm-3 text-secondary">
                                    @if($match->status == 'search')
                                        <div class="mb-0 alert alert-dark">Поиск игроков</div>
                                    @elseif($match->status == 'start')
                                        <div class="mb-0 alert alert-warning">В процессе</div>
                                    @elseif($match->status == 'summarizing')
                                        <div class="mb-0 alert alert-primary">Подведение итогов</div>
                                    @else
                                ...
                                <div class="col-sm-2">
                                    <h6 class="mb-0">{{ $match->creator->name }}</h6>
                                </div>
                                <div class="col-sm-1">
                                    <h6 class="mb-0">vs</h6>
                                </div>
                                <div class="col-sm-2">
                                    @if($match->opponent->name)
                                        <h6 class="mb-0">{{ $match->opponent->name }}</h6>
                                    @else
                                        <h6 class="mb-0">Не определен</h6>
                                    @endif
                                </div>
                                <div class="col-sm-1">
                                    <td>
